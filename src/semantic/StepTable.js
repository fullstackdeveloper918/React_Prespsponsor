...
// export const StepTable = ()=>(
    ...
    componentDidMount(){
      ...
      axios.get('http://localhost/presponsor/public/api/selectPackage')
      .then(response=>{
      ...
      
      {
            ...
            posts.length?posts.map(post=> <tr>
               ...
               <td>{post.Total}</td>
               {/* <button className="btn btn-primary">{post.id}Edit</button> */}
              
             <Link to={"/edit.component/"+post.id} className="btn btn-primary">Edit</Link>
